...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <p>Thank you for contacting Steady Formation support! We have successfully received your support ticket.</p>
            ...
            <p>Our support team has been notified and will review your ticket. We typically respond within 24-48 hours during business days.</p>

            <p>You can track the status of your ticket and add additional comments by clicking the button below:</p>

            <div style="text-align: center;">
                <a href="{{$ticketUrl}}" class="button">View Ticket</a>
            </div>

            <p>If your issue is urgent, please feel free to contact us directly:</p>
