...
<head>
    ...
    <title>Account Credited | Steady Formation</title>
    <style>
        body {
...
<body>
    <div class="email-container">
        ...
        <div class="header">
            ...
            <p style="margin: 10px 0 0 0; opacity: 0.9;">Your Account Has Been Credited</p>
        </div>
        ...
        <div class="content">
            ...
            <p>We're happy to inform you that your account has just been credited with the following amount:</p>

            <!-- Transaction Details -->
            <div class="transaction-box">
                <div class="transaction-item">
                    <span class="transaction-icon">💳</span>
                    <span class="transaction-label">Amount Credited:</span>
            ...
            <p>You can log in to your dashboard anytime to review this transaction and manage your funds. If you have any questions, our support team is always ready to help.</p>
            ...
            <p>Thank you for trusting Steady Formation with your business journey.</p>
