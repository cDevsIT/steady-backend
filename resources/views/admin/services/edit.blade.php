...
@push('title')
    Edit {{ $service->name }} - Service Configuration
@endpush
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="page-header-modern mb-4">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h1 class="page-title-modern mb-2">Edit Service</h1>
                    <p class="page-subtitle-modern">{{ $service->name }} - Service Configuration</p>
                </div>
            ...
            <div class="row">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" min="0" 
                                           ...
                                           id="initial_price" name="initial_price" 
                                           value="{{ old('initial_price', $service->initial_price) }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" min="0" 
                                           ...
                                           id="renewal_fee" name="renewal_fee" 
                                           value="{{ old('renewal_fee', $service->renewal_fee) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" step="0.01" min="0" 
                                           ...
                                           id="transfer_fee" name="transfer_fee" 
                                           value="{{ old('transfer_fee', $service->transfer_fee) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" min="0" 
                                           ...
                                           value="{{ old('renewal_period', $service->renewal_period) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select @error('purchase_type') is-invalid @enderror" 
                                        ...
                                        <option value="direct" {{ old('purchase_type', $service->purchase_type) == 'direct' ? 'selected' : '' }}>Direct Purchase</option>
                                        <option value="funnel" {{ old('purchase_type', $service->purchase_type) == 'funnel' ? 'selected' : '' }}>In Funnel</option>
                                        <option value="both" {{ old('purchase_type', $service->purchase_type) == 'both' ? 'selected' : '' }}>Both</option>
                                    </select>
                        ...
                        <div class="card-body p-4">
                            ...
                            <div id="featuresContainer">
                                @php
                                    ...
                                    $currentFeatures = $service->features->pluck('feature')->toArray();
                                    $features = $oldFeatures ?: $currentFeatures;
                                @endphp
                                @if(count($features) > 0)
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_renewable" name="is_renewable" 
                                               {{ old('is_renewable', $service->is_renewable) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="auto_renewal" name="auto_renewal" 
                                               {{ old('auto_renewal', $service->auto_renewal) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="visible_on_funnel" name="visible_on_funnel" 
                                               {{ old('visible_on_funnel', $service->visible_on_funnel) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_transferable" name="is_transferable" 
                                               {{ old('is_transferable', $service->is_transferable) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="requires_state_selection" name="requires_state_selection" 
                                               {{ old('requires_state_selection', $service->requires_state_selection) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="requires_state_fees" name="requires_state_fees" 
                                               {{ old('requires_state_fees', $service->requires_state_fees) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" id="is_for_address" name="is_for_address" 
                                               {{ old('is_for_address', $service->is_for_address) ? 'checked' : '' }}>
                ...
                <div class="col-lg-4">
                    <div class="sticky-top" style="top: 2rem;">
                        ...
                        <div class="card border-0 shadow-sm">
                            <div class="card-header bg-transparent border-0 py-3">
                                <h5 class="card-title-modern mb-0">Service Status</h5>
                            </div>
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <span class="badge bg-{{ $service->status_badge }} fs-6 px-3 py-2 mb-3">
                                        <i class="fas fa-check-circle me-1"></i>{{ $service->status }}
                                    </span>
                                    <p class="text-muted mb-0">Current service status</p>
                                </div>
                            </div>
                        </div>
                    </div>
